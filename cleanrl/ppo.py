...
def evaluate_deterministic(env_id, pi: Agent, max_ep_len, device, episodes=5):
    ...
    for ep in range(episodes):
        ...
        while not done and steps < max_ep_len:
            ...
            a = pi.get_action_and_value(obs_t)[0]
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        #Evaluate episodes
        if iteration % 10 == 0:
            eval_return = evaluate_deterministic(args.env_id, agent, 500, device)
            print(f"eval return at iteration {iteration}: {eval_return}")
        ...
        print("SPS:", int(global_step / (time.time() - start_time)), "Global Step:", global_step)
